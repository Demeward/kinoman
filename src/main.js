...
const createTotalMovieCountTemplate = () => {
  return (
...
const filmListElement = document.querySelectorAll('.films-list .films-list__container')[0];
const topRatedfilmsElement = document.querySelectorAll('.films-list .films-list__container')[1];
const mostCommentedfilmsElement = document.querySelectorAll('.films-list .films-list__container')[2];

for ( let i = 0; i < FILM__COUNT; i++) {
  render(filmListElement, createFilmCardTemplate(), 'beforeend');
}

for ( let i = 0; i < EXTRA__FILM__COUNT; i++) {
  render(topRatedfilmsElement, createFilmCardTemplate(), 'beforeend');
}

for ( let i = 0; i < EXTRA__FILM__COUNT; i++) {
  render(mostCommentedfilmsElement, createFilmCardTemplate(), 'beforeend');
}
...
render(footerElement, createTotalMovieCountTemplate(), 'beforeend');
